...
$$
\phantom{}_{B^{\prime}}{[M^T]}_{B^{\prime}} = \underbrace{\phantom{}_{B^{\prime}}{[1]}_{B}}_{B \to B^\prime}\phantom{}_{B}{[M^T]}_{B}\und\phantom{}_{B}{[1]}_{B^{\prime}}
$$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU1ODIyNTUyNCwtMTk0NzEyNDY2MywxNT
