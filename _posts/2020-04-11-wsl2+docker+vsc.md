...
- 확장이 docker에 접속을 못하면서 생기는 일인데, vsc 혹은 vsc insider를 '완전히' 지워줘야 한다. 기본적인 언인스톨 이외에 아래의 작업을 꼭 해주자.[^3] `%appdata%` 안의 정보가 살아 남아 컨테이너 접속을 방해하는 것으로 추정된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTgxMDc2MzM5MSwxNjY5MTQzMjAyLC03MT
