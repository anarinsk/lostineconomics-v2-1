...
- 가상환경을 만들 때, 즉 `python -m venv...`에서 `sudo`를 안 쓰게 좋다. 이렇게 가상환경을 만들면 해당 디렉토리가 root의 소유가 된다. VS code 등이 해당 디렉토리에 접근해 변형할 수 없게 된다.  
...
...
```
- 만일 가상환경 내에서 `pip-review`가 필요하다면, 각 가상환경 내에 깔아야 한다는 점을 기억하자. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNDIxOTY5NSwtNzg3MzExMjQ2LC02Nz
Y1MjYzMTAsLTc1OTM5OTY4NiwzMjIxMDEwMTgsLTE4Nzg2NzQ4
MDEsLTMzNjUxNjU0NywtNjEzNjY1MjIyLDE4MTU1MjM3NTksLT
MzMTA0NjAyMCwxMDY5Mzk4ODgyLDE1MDI2ODczNDQsLTkyNTc4
ODM5NywtMjAyODU0NTI5OSwtNTUyNTM2ODcwLC00NjY3NTk5NT
gsODAyNTI2MTI4LDIxMTU5MTA2MTcsMTA3NjAxNjM0NywtMjAx
MzU5Nzk4N119
-->