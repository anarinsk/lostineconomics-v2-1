...
#### pip-review 
conda처럼 편리한 패키지 업데이트가 필요하다면 이 녀석을 설치하도록 하자.{^4]

[^4]: 상세한 내용을 [https://github.com/jgonggrijp/pip-review](https://github.com/jgonggrijp/pip-review) 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODA0MTA5NDQsLTE1MTE2ODYxODAsLTk2MD
