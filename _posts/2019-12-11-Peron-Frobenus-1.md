...
확률 행렬를 활용해서 마르코프 체인의 문제를 어떻게 풀까? 일단 적당한 형태의 확률 행렬 $P$가 있다고 하자. 즉 $P$는 비음이고 $P^k > 0$이 성립한다(즉, $P$는 정칙 행렬). 이제 $P$에  페론-프로베니우스의 정리를 적용할 수 있다. 즉,  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjg1MDYxNDQsMjY3Nzk3NTY4LDIxMj
E1OTk2N119
-->