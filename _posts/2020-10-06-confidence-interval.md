...
이제 $\mu$ 구간의 의미를 새겨보자. 미지의 그리고 이미 결정된 모수 $\mu$는 대략 저 사이에 있을 것으로 표본을 통해 파악했다. 이 진술을  95% 정도의 강도로 믿을 수 있다는 이야기다. 다시 강조하지만, $\mu$가 저 안에 있을 확률이 95%라는 말은 아니다. 이 말은 오히려 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM4NjIwNTM1MSwtNjA3MjgyNTU5LC0yMj
