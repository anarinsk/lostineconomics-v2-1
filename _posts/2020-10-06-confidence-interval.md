...
[^1]: 점근적으로 말하면, 즉 $n \to \infty$가 됨에 따라서, 표본 분산, $S = \lim_{n \to \infty} \sum_{i=1}^n \frac{{(X_i - \overline{x})^2}}{n-1} \to \sigma^2$이 된다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU5Mjc3NTc0NywtNjA3MjgyNTU5LC0yMj
