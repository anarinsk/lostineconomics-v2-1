...
[^1]: $n$이 어느 정도 크다면 (대략 $n \geq 30$)이라고 하면, $\sigma / n$을 $S / n$으로 대체해도 괜찮다. 여기서 $S$는 $/sigma$의 추정치다. 즉 $S = \dfrac{1}{n-1} \sum_{i=1}^n (X_i - \overline{X})$
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDA3NTgzMjY5LDExMjczMDQ1MjMsLTUyOD
