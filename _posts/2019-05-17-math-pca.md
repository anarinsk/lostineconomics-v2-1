...
이 프로젝션의 벡터 $w$ 위의 이미지는 $(w \cdot x_i) w$가 된다. 
...
### Variance-covariance matrix 
 ...
 왜 분산이 등장하는지를 파악했으니 분산 최대화를 계산해볼 차례다.  아래 행렬 $X$를 통해 쉽게 분산-공분산 행렬을  나타낼 수 있다. $x_i^j$ 에서 $i (=1,2,\dotsc, n)$는 관찰을, $j(=1,2,\dotsc,k)$는 피쳐를 나타낸다. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY2NzA3Mzg1MV19
-->